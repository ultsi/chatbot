        ...
        switch (_a.label) {
            ...
            case 3:
                ...
                if (Math.random() > 1 - CHANCE || mention) {
                    foundKey = markovGenerator.findPartialKeyFromData(mention ? "@" + text : text) // search based on actual text content, not the highlight tag
                    ;
                    if (foundKey !== '') {
                ...
                _a.label = 4;
            case 4:
                if (wordsWithoutHighlights.length < MARKOV_ORDER + 1 || msg.forward_from)
                    return [2 /*return*/];
